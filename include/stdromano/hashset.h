...
public:
    ...
    class const_iterator 
    {
        ...
        const_iterator(typename Base::const_iterator it) : base_iterator(it) {}
    ...
    iterator begin() const { return const_iterator(Base::cbegin()); }
    iterator end() const { return const_iterator(Base::cend()); }
