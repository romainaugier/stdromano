...
TEST_CASE(test_constructor_and_destructor)
{
    // Default constructor
    {
        stdromano::StackVector<TestObject, 4> vec;
    ...
    {
        stdromano::StackVector<TestObject, 5> vec(5, TestObject("test"));
